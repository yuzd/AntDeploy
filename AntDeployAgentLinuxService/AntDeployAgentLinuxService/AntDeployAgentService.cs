...
{
    public class AntDeployAgentService : BackgroundService
    {
        private Startup _startup;
        private readonly ILogger<AntDeployAgentService> _logger;

        public AntDeployAgentService(ILogger<AntDeployAgentService> logger)
        {
            _logger = logger;
        }
