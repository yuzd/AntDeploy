...
namespace AntDeployVsix
{
    ...
    [Guid(AntDeployPackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideAutoLoad(UIContextGuids80.SolutionExists, PackageAutoLoadFlags.BackgroundLoad)]
    public sealed class AntDeployPackage : AsyncPackage, IDisposable
    {
        ...
        /// <summary>
        /// AntDeployPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "4c33689a-2cd4-4115-b67c-d0b5ab6a507a";

        /// <summary>
        /// Initializes a new instance of the <see cref="AntDeployPackage"/> class.
        /// </summary>
